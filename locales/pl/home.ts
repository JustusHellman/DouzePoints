export default {
  "greenroom": {
    "greenroom": "Greenroom",
    "description": "Zrelaksuj się i przygotuj do występu. Udowodnij swoją wiedzę o Konkursie Piosenki Eurowizji w sześciu codziennych wyzwaniach zaprojektowanych dla największych fanów.",
    "dailyProgress": "Dzisiejszy postęp",
    "qualified": "✨ Zakwalifikowano do Wielkiego Finału ✨",
    "finishedToday": "Ukończono dzisiaj",
    "statsButton": "Statystyki",
    "careerStats": "Statystyki",

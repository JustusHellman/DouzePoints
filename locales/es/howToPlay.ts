export default {
  "games": {
    ...
    "eurolinks": {
      ...
      "rulesLong": "EuroLinks es un juego de lógica y trivia de Eurovisión. Debes encontrar las conexiones ocultas entre 16 elementos diferentes relacionados con el concurso.\n\nCómo jugar:\n• La cuadrícula contiene 16 elementos que se pueden agrupar en cuatro categorías de cuatro elementos cada una.\n• Selecciona cuatro elementos y toca 'Enviar' para comprobar si comparten una categoría.\n• Si tu intento es correcto, la categoría será revelada.\n• Si es incorrecto, cuenta como un error. Si tienes 3 elementos correctos, se te notificará que estás \"a uno\".\n• Tienes 6 errores permitidos para resolver todo el rompecabezas.\n• Cada categoría tiene un nivel de dificultad, revelado por su color cuando se resuelve: Amarillo (Fácil), Verde (Medio), Azul (Difícil) y Púrpura (Experto)."
    },
    "euroguess": {
      "title": "EuroGuess",

export default {
  "greenroom": {
    ...
    "howToPlayP3": "Al jugar los juegos diarios, también ganarás paquetes para construir tu EuroCollection de cartas coleccionables digitales. ¡Averigua si puedes encontrarlas todas para demostrar tu estatus de súper fan!"
  }
};

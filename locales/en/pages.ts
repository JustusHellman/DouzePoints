export default {
  "privacy": {
    ...
    "localStorage": {
      ...
      "p2": "We use local browser storage and secure Google session tokens strictly to keep you signed in and preserve your game progress."
    },
    "dataSharing": {
  ...
  "about": {
    ...
    "games": {
      ...
      "gameList": [
        {
          "name": "EuroSong",
          "desc": "A Wordle-style song title guessing game."
        },
        {
          "name": "EuroArtist",
          "desc": "Identify the performer in 6 tries."
        },
        {
          "name": "EuroRefrain",
          "desc": "Connect lyrics to their iconic hooks."
        },
        {
          "name": "EuroLinks",
          "desc": "Find the hidden connections between ESC items."
        },
        {
          "name": "EuroGuess",
          "desc": "The ultimate mystery entry quiz."
        },
        {
          "name": "EuroArena",
          "desc": "A data-driven battle of Eurovision stats."
        }
      ]
    },
    "community": {

...
export const de: TranslationSchema = {
  ...
  privacy: {
    ...
    dataSharing: {
      ...
      items: ["Hosting-Anbieter", "Technische Dienstleister, die für den Betrieb der Website erforderlich sind"]
    },
  ...
  metadata: {
    countries: {
      ...
      "Yugoslavia": "Jugoslawien", "Serbia & Montenegro": "Serbien & Montenegro",

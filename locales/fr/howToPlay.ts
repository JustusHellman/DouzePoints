export default {
  "games": {
    ...
    "eurolinks": {
      ...
      "rulesLong": "EuroLinks est un jeu de logique et de trivia sur l'Eurovision. Vous devez trouver les liens cachés entre 16 éléments différents liés au concours.\n\nComment jouer :\n• La grille contient 16 éléments qui peuvent être regroupés en quatre catégories de quatre éléments chacune.\n• Sélectionnez quatre éléments et appuyez sur 'Soumettre' pour vérifier s'ils partagent une catégorie.\n• Si votre réponse est correcte, la catégorie sera révélée.\n• Si elle est incorrecte, cela compte comme une erreur. Si vous avez 3 éléments corrects, vous serez averti qu'il ne vous en manque qu'un.\n• Vous avez droit à 6 erreurs pour résoudre l'ensemble du puzzle.\n• Chaque catégorie a un niveau de difficulté, révélé par sa couleur une fois résolue : Jaune (Facile), Vert (Moyen), Bleu (Difficile) et Violet (Expert)."
    },
    "euroguess": {
      "title": "EuroGuess",

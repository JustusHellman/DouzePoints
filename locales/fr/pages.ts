export default {
  "privacy": {
    ...
    "localStorage": {
      ...
      "p2": "Nous utilisons le stockage local du navigateur et des jetons de session sécurisés Google uniquement pour vous garder connecté et préserver votre progression de jeu."
    },
    "dataSharing": {
  ...
  "about": {
    ...
    "games": {
      ...
      "gameList": [
        {
          "name": "EuroSong",
          "desc": "Un jeu de devinettes de titres de chansons de style Wordle."
        },
        {
          "name": "EuroArtist",
          "desc": "Identifiez l'interprète en 6 tentatives."
        },
        {
          "name": "EuroRefrain",
          "desc": "Reliez les paroles à leurs refrains emblématiques."
        },
        {
          "name": "EuroLinks",
          "desc": "Trouvez les liens cachés entre les éléments de l'ESC."
        },
        {
          "name": "EuroGuess",
          "desc": "Le quiz ultime sur les entrées mystères."
        },
        {
          "name": "EuroArena",
          "desc": "Une bataille de statistiques de l'Eurovision basée sur les données."
        }
      ]
    },
    "community": {

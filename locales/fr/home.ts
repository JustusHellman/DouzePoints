export default {
  "greenroom": {
    ...
    "howToPlayP3": "En jouant aux jeux quotidiens, vous gagnerez également des paquets pour construire votre EuroCollection de cartes à collectionner numériques. Essayez de toutes les trouver pour prouver votre statut de super fan !"
  }
};

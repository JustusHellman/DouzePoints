export default {
  ...
  "settings": {
    "title": "Einstellungen",
    "account": "Konto & Synchronisierung",
    "signIn": "Anmelden",
    "signInWithGoogle": "Mit Google anmelden",
    "signInDesc": "Sichere deine Kartensammlung, täglichen Serien und Highscores auf all deinen Geräten.",
    "guestAccount": "Gastprofil",
    "guestDesc": "Dein Fortschritt wird nur in diesem Browser gespeichert. Verbinde ein Konto, um ihn in der Cloud zu sichern.",
    "cloudSynced": "Cloud-Sync aktiv",
    "signedInAs": "Angemeldet als",
    "signOut": "Abmelden",
    "adminDashboard": "Admin-Dashboard",
    "userId": "Benutzer-ID",
    "copyUserId": "Benutzer-ID kopieren",
    "selectAvatar": "Profilbild auswählen",
    "soundEffects": "Soundeffekte",
    "soundEffectsDesc": "Spiel- und Paketöffnungssounds aktivieren oder deaktivieren",
    "on": "EIN",
    "off": "AUS",
    "saveAndClose": "Speichern & Schließen"
  },
  "auth": {
    "pill": "Cloud-Speicherung & Sync",
    "title": "Bei Douze Points anmelden",
    "subtitle": "Verliere nie deine Karten, täglichen Serien oder Meilensteine. Verbinde dein Konto, um auf all deinen Geräten zu spielen.",
    "backupTitle": "EuroCollection-Backup",
    "backupDesc": "Halte jede Karte, jedes Paket und Konfetti sicher in der Cloud gespeichert.",
    "statsTitle": "Karrierestatistiken & Ränge",
    "statsDesc": "Behalte alle täglichen Spielrekorde, Max-Serien und steige in den Greenroom-Rängen auf.",
    "crossDeviceTitle": "Geräteübergreifende Freiheit",
    "crossDeviceDesc": "Spiele unterwegs auf dem Handy und mach nahtlos am Desktop weiter, ohne Fortschritt zu verlieren.",
    "continueWithGoogle": "Weiter mit Google",
    "connecting": "Verbinde...",
    "continueAsGuest": "Als Gast weiterspielen",
    "privacyNote": "Wir verwenden lokalen Browserspeicher und sichere Google-Sitzungs-Tokens ausschließlich dazu, dich angemeldet zu halten und deinen Spielfortschritt zu bewahren."
  }
};

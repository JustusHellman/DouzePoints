export default {
  "games": {
    ...
    "eurolinks": {
      ...
      "rulesLong": "EuroLinks ist ein Logik- und Eurovision-Trivia-Spiel. Du musst die versteckten Verbindungen zwischen 16 verschiedenen Elementen im Zusammenhang mit dem Wettbewerb finden.\n\nSpielanleitung:\n• Das Raster enthält 16 Elemente, die in vier Kategorien zu je vier Elementen gruppiert werden können.\n• Wähle vier Elemente aus und tippe auf 'Senden', um zu prüfen, ob sie eine Kategorie teilen.\n• Wenn dein Tipp richtig ist, wird die Kategorie aufgedeckt.\n• Wenn er falsch ist, zählt dies als Fehler. Wenn du 3 richtige Elemente hast, wirst du benachrichtigt, dass dir nur noch eins fehlt.\n• Du hast 6 Fehler frei, um das gesamte Rätsel zu lösen.\n• Jede Kategorie hat einen Schwierigkeitsgrad, der durch ihre Farbe nach dem Lösen angezeigt wird: Gelb (Einfach), Grün (Mittel), Blau (Schwer) und Lila (Experte)."
    },
    "euroguess": {
      "title": "EuroGuess",

export default {
  "privacy": {
    ...
    "legalBasis": {
      ...
      "consent": "für nicht-essenzielle Cookies (falls vorhanden).",
    ...
    "localStorage": {
      ...
      "p2": "Wir verwenden lokalen Browserspeicher und sichere Google-Sitzungs-Tokens ausschließlich dazu, Sie angemeldet zu halten und Ihren Spielfortschritt zu bewahren."
    },
    "dataSharing": {
    ...
    "internationalTransfers": {
      ...
      "p1": "Einige Drittanbieter können Daten außerhalb der EU oder des EWR verarbeiten. Wo solche Übermittlungen stattfinden, werden angemessene Garantien wie Standardvertragsklauseln verwendet."
    },
    "dataRetention": {
  ...
  "about": {
    ...
    "games": {
      ...
      "gameList": [
        {
          "name": "EuroSong",
          "desc": "Ein Songtitel-Ratespiel im Wordle-Stil."
        },
        {
          "name": "EuroArtist",
          "desc": "Identifizieren Sie den Interpreten in 6 Versuchen."
        },
        {
          "name": "EuroRefrain",
          "desc": "Verbinden Sie Songtexte mit ihren ikonischen Hooks."
        },
        {
          "name": "EuroLinks",
          "desc": "Finden Sie die versteckten Verbindungen zwischen ESC-Elementen."
        },
        {
          "name": "EuroGuess",
          "desc": "Das ultimative Quiz zu mysteriösen Beiträgen."
        },
        {
          "name": "EuroArena",
          "desc": "Ein datengesteuerter Kampf der Eurovision-Statistiken."
        }
      ]
    },
    "community": {

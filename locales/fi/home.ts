export default {
  "greenroom": {
    "greenroom": "Greenroom",
    "description": "Rentoudu ja valmistaudu esitykseen. Todista tietosi Eurovision laulukilpailusta kuudella päivittäisellä haasteella, jotka on suunniteltu todellisille superfaneille.",
    "dailyProgress": "Päivän edistyminen",
    "qualified": "✨ Finaalipaikka varmistettu ✨",
    "finishedToday": "Valmiina tältä päivältä",
    "statsButton": "Tilastot",
    "careerStats": "Tilastot",

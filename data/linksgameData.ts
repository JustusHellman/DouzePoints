...
export const PUZZLES: ConnectionsGroup[][] = [
  ...
  [
    ...
    { category: "Winners who topped both jury and televote (since 2009)", items: ["EUPHORIA", "SATELLITE", "AMAR PELOS DOIS", "FAIRYTALE"], difficulty: "expert" }
  ],
  [
  ...
  [
    { category: "Winners topping both jury and televote since 2009", items: ["FAIRYTALE", "EUPHORIA", "SATELLITE", "AMAR PELOS DOIS"], difficulty: "easy" },

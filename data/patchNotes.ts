...
export const PATCH_NOTES: PatchNote[] = [
  ...
  },
  {
    id: "13",
    date: "2026-09-25",
    title: "Login & Device sync using Google",
    description: "I'm back from a nice vacation and here comes a small but also large update - We finally have the option to login, making it possible to sync your progress across multiple devices (for example PC and phone)! Just go to the avatar in the top right corner and sign in (no actual credentials are shared or stored by me)!\n\nI hope you'll enjoy it and take care out there!",
  }
];
